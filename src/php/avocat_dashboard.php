...
<body>
    ...
    <main>
        <div class="font-sans">
        <div class="grid lg:grid-cols-2 items-center lg:gap-y-6 bg-gradient-to-r from-yellow-900 to-yellow-500">
            <div class="max-lg:order-1 max-lg:text-center sm:p-12 p-4">
            <h2 class="text-white lg:text-5xl text-3xl font-bold lg:!leading-[56px]">Une Solution Pratique pour l'Avocat Moderne</h2>
            <p class="text-white mt-6 text-base font-semibold leading-relaxed">Offrir des réservations en ligne permet de gérer facilement les rendez-vous, d'améliorer l'organisation du cabinet et de répondre rapidement aux clients. C'est une solution essentielle pour gagner en efficacité et rester compétitif.</p>
            </div>

            <div class="lg:h-[480px] flex items-center">
            <img src="https://www.avocat-travail-montpellier.com/upload/avocat-en-ligne-1609426509-35915.jpg" class="w-full h-full object-cover" alt="Dining Experience" />
            </div>
        </div>
